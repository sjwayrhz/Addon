...
local fish_track = {
	...
	author = "Usb",
	version = "1.0",
	desc = "Track Buff For Family Quest"
}
...
local fishBuffIdsToAlert = {
    [1] = "Stoke Fire",
	[1] = "Taste Stew",
	[20308] = "Add Ingredients",
	[1] = "Weakened Rind",
	[1] = "Dry Rind",
	[20301] = "Bored Sheep",
    [1] = "Hungry Sheep",   
    [1] = "Thriving",
    [1] = "Vulnerable to Core Cleaving",
    [1] = "Vulnerable to Limb Lopping",
    [1] = "Vulnerable to Trunk Chopping",
}

local fishNamesToAlert = {
	["Regional Stew Pot"] = true,
    ["Stonerind Pumpkin"] = true,
    ["Golden Sheep"] = true,
    ["Ironwood Tree"] = true,
}
...
local function OnLoad()
	api.Log:Info("Add tracking icons to family quest")
